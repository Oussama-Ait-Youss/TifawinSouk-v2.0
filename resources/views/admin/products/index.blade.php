...
<body class="h-full">
        ...
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <nav class="flex space-x-4">
                    <button class="px-3 py-2 text-sm font-medium text-gray-500 transition-colors rounded-md hover:text-gray-700">
    ...
    <main class="px-4 py-8 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <!-- Stats Cards -->
        <div class="grid grid-cols-1 gap-6 mb-8 md:grid-cols-4 fade-in">
        ...
        <div class="p-6 mb-6 bg-white border border-gray-200 shadow-sm rounded-xl fade-in">
            <div class="flex flex-col items-center justify-between gap-4 sm:flex-row">
                <div class="relative w-full sm:w-96">
                    <input type="text" 
                           placeholder="Search products..." 
                           class="w-full py-2 pl-10 pr-4 transition-all border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
